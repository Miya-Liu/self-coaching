...
| [coaching_api.md](coaching_api.md) | **Coaching API (T2)** | HTTP spine for learn / self-questioning / eval / train |
...
SelfCoachingClient  <-- mock-services/client.py
       ...
       +-- learn / self_questioning       -> Coaching API mock; learn evolve API migration M2 (spec only)

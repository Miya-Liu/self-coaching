...
| Self-play | **M3 complete** | `mock_self_play.py` + pipeline adapter | Opt-in `pipeline-integration` workflow |
...
## Migration M3 — self-play (pipeline service)

**Tracker:** [self-play-pipeline-implementation.md](self-play-pipeline-implementation.md)  
**Analysis:** [self-play-integration-plan.md](self-play-integration-plan.md)  
...
| Sprint 1 | `SelfPlayPipelineEngine` + proceed signal (no Supabase export) | **done** |
...
- **2026-06-16:** Migration M3 — pipeline self-play adapter (Sprints 0–3), proceed-only contract, opt-in CI

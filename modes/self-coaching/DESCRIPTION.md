---
description: "Installable self-coaching skill: umbrella policy plus submodules self-learning, self-questioning, self-evaluation, self-tuning for host agent self-evolution."
---

# self-coaching mode

A **portable skill** for coaching a host agent through a gated loop: observe experience, improve via **self-learning** and **self-questioning**, measure with **self-evaluation**, optionally **self-tuning**, record **Experience**, and merge only after human approval.
...
| **self-questioning** | `self-questioning/` | Generate and curate tasks and trajectories |

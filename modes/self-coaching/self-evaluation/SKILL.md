...
| Failure type | Route |
|---|---|
| Forgot a known procedure, tool verification, or project convention | `self-learning/SKILL.md` |
| Missing or weak eval coverage | `self-play/SKILL.md` |
| Repeated model capability failure despite skills/tools/prompts | `self-tuning/SKILL.md` |

...
class _EvalOverrideClient:
    """Delegate learn/self_play/train to inner client; eval via AgentEvals."""
    ...
    def evaluate(self, *, candidate: str = "mock-candidate-v1", baseline: str = "mock-baseline-v0") -> dict[str, Any]:
...
def with_agentevals_eval(inner: Any, eval_adapter: AgentEvalsEvalAdapter | None = None) -> Any:
    """Wrap a SelfCoachingClient so evaluate/eval_report use AgentEvals."""
    return _EvalOverrideClient(inner, eval_adapter or AgentEvalsEvalAdapter())
